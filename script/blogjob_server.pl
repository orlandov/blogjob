...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{BLOGJOB_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{BLOGJOB_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
blogjob_server.pl - Catalyst Testserver

=head1 SYNOPSIS

blogjob_server.pl [options]
